  ...
  return (
    <header>
      ...
      <ul className={styles.headerRight}>
        <li style={{display: 'flex', alignItems: 'center', cursor: 'pointer'}} onClick={props.onClickOpenDrawer}>
        ...
        <li style={{cursor: 'pointer'}}>
          <svg className="svgFill" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

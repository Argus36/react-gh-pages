...
export function Header() {
  ...
  const {setCartOpened, totalPrice} = React.useContext(AppContext);
  const price = totalPrice + totalPrice * 0.05

  return (
    <div>
      <header>
        <Link id="Link" to="/react-gh-pages" style={{textDecoration: 'none', color: 'inherit'}}>
        ...
        <ul className={styles.headerRight}>
          <li style={{display: 'flex', alignItems: 'center', cursor: 'pointer'}} onClick={setCartOpened}>
            <svg className="svgStroke" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>{`${price}`.slice(0, -3) + " " + `${price}`.slice(-3)} руб.</span>
          </li>
          <li>
            <Link to="/react-gh-pages/favorites" style={{textDecoration: 'none', color: 'inherit'}}>
              <svg style={{paddingTop: '1vh'}} className="svgFill" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  <clipPath id="clip0_60_590">
                    <rect width="18.11" height="16.299"/>
                  </clipPath>
                </defs>
              </svg>
            </Link>
          ...
          <li style={{cursor: 'pointer'}}>
            <svg className="svgFill" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
